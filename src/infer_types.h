...
int unify(AST *x, AST *y, EnvKV **env)
{
    ...
    else if (x->ast_type == AST_LIST && y->ast_type == AST_LIST)
    {
        ...
        {
            printf("in list, could not unify (empty)\n");
            prin_ast(x);
            printf(" = ");
            print_ast(y);
            return 0;
        ...
        {
            printf("in list, could not unify (differing length)\n");
            prin_ast(x);
            printf(" = ");
            print_ast(y);
            return 0;
